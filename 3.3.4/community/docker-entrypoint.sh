...
: ${NEO4J_dbms_memory_heap_initial__size:=${NEO4J_dbms_memory_heap_maxSize:-"1g"}}
: ${NEO4J_dbms_memory_heap_max__size:=${NEO4J_dbms_memory_heap_maxSize:-"4g"}}
...
: ${NEO4J_dbms_auto__index_nodes_keys:="name,country,city,region"}
